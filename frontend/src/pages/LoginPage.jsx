...
const LoginPage = () => {
    ...
    return (
        <div className='max-w-xl mx-auto'>
            <h2 className="font-bold text-3xl mb-4 text-center">User login</h2>
            ...
            <div>
                <p className='font-semibold mt-4 text-lg'>You don't have a user? Sign up here!</p>
                <button onClick={() => navigate('/register')} className='bg-green-500 p-3 rounded-lg block w-1/2 mx-auto mt-3'>Sign up</button>
            </div>
        </div>
    )
}
