    ...
    return (
        <div className='max-w-xl mx-auto'>
            ...
            <form onSubmit={loginUser}>
                ...
                <input type="submit" value='Login'  className="bg-indigo-500 hover:bg-indigo-400 p-3 rounded-lg block w-1/2 mx-auto mt-3 cursor-pointer"/>
            </form>
            <div>
                <p className='font-semibold mt-4 text-lg text-[#F4EAE0]'>You don't have a user? Sign up here!</p>
                <button onClick={() => navigate('/register')} className='bg-green-500 hover:bg-green-400 p-3 rounded-lg block w-1/2 mx-auto mt-3 text-[#F4EAE0]'>Sign up</button>
            </div>
        </div>
    )
}
