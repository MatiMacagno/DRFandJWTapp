...
function RegisterPage() {
  ...
  return (
      <div className='max-w-xl mx-auto'>
            <h2 className="font-bold text-3xl mb-4 text-center">User register</h2>
          ...
          <label className='font-semibold text-lg'>Email</label>
              ...
              <input type="submit" value='Sign up' className='bg-green-500 p-3 rounded-lg block w-1/2 mx-auto mt-3 cursor-pointer'/>
          </form>
      </div>
  )
}
